...
Options:
  ...
  --org "<n>"  Scrape a single organization by name
...
async function scrapeSingleOrganization(orgName) {
    ...
    // Find organization by name in scrapable list first
