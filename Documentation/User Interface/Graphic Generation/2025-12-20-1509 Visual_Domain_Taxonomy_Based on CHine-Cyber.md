...
## Canonical Reference: China / Cyber Image
...
* The goal is to ensure stylistic consistency, controlled flexibility, and prevention of cinematic or narrative drift.
* All automated image generation MUST conform to these rules unless explicitly overridden by documented exceptions.
...
*If an image implies when something happened, it violates this domain.*

---

## 2. ABSTRACTION AXIS (PRIMARY CONTROL)
...
## 6. NATIONAL & MILITARY REPRESENTATION
...
*A tank may appear as a symbol, not as part of an action scene.*
...
## 10. CANONICAL DEFAULT GENERATION PROFILE
