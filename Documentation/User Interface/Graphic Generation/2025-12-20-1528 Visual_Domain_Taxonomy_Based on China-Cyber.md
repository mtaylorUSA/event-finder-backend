...
# DOCUMENT PURPOSE
     ...
     * It ensures stylistic consistency, controlled flexibility, and prevents cinematic, narrative, or sci‑fi drift.
...
# SYMBOLIC LANGUAGE RULES
     ...
     * Rules:
          ...
          ** No logos
          ** No numbers
          ** No official seals or emblematic frames
...
# CELESTIAL OBJECT CONSTRAINTS (NEW)
     * Maximum of one celestial body per image
     * Celestial bodies include:
          ** Earth
          ** Planets
          ** Moons
          ** Any spherical form that reads as planetary or orbital

     * Forbidden:
          ** Multiple planets or Earth depictions
          ** Planet-like luminous discs or halos exceeding ~15% of frame width
          ** Sci‑fi space compositions

     * Atmospheric light must be:
          ** Diffuse
          ** Non-circular
          ** Non-orbital in appearance

---

# SEMANTIC ZONING (NEW)
     * Images may be composed of up to four semantic zones:
          ** Context Zone (global, environmental, systemic)
          ** Pressure Zone (emissions, industry, risk)
          ** Transition Zone (policy, governance, dialogue)
          ** Solution Zone (mitigation, adaptation, renewables)

     * Zones define symbolic role, not strict layout geometry.

---

# ZONE EXCLUSIVITY RULES (NEW)
     * Symbols must align with the role of the zone they occupy
     * Pressure symbols may not appear in Solution Zones
     * Solution symbols may not appear in Pressure Zones
     * Context Zones may not contain dominant icons

---

# POSITIONAL OVERRIDE RULE (NEW)
     * When explicit positional or relocation instructions are provided:
          ** They override inferred semantic gradients
          ** They override conventional left‑to‑right narratives

     * Symbol relocation must be honored even if it disrupts learned visual flows.
...
# COLOR & MATERIAL SYSTEM
     * Color Logic:
          ** Warm hues: authority, governance, pressure
          ** Cool hues: digital systems, environment, mitigation
