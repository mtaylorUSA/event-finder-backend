...
2. **Admin reviews** for mission fit → approves or rejects
3. **Admin requests permission** from org POCs
4. **Permission granted** → enable scraping
5. **Permission denied** → add to `rejected_organizations`
