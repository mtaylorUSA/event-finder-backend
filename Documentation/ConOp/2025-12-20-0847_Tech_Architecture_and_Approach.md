# DOCUMENT NAME:  2025-12-13-2100 Tech Architecture and Approach.md
...
# HOW TO USE THIS DOCUMENT
     ...
     * This document is the authoritative reference for the image generation program.
     * It defines methodology, constraints, and design intent — not individual prompts.
     * New AI sessions should:
          ** Read this document in full before proposing changes
          ** Treat defined domains, modifiers, and constraints as binding
          ** Propose refinements only when repeated failure modes are observed
     * Implementation details are intentionally separated and handled by Claude-generated code.
...
# NON-GOALS
     ...
     * This program is not intended to:
          ...
          ** Depict real people, leaders, or specific events
          ** Create cinematic, entertainment-oriented, or sensational visuals
          ** Produce literal or documentary-style representations
     * Editorial abstraction and symbolic representation are intentional design choices.
...
# GLOSSARY
     ...
     * Visual Domain
          ** A high-level constraint defining the physical and aesthetic world of an image

     * Modifier
          ** An opt-in extension allowing specific subjects without changing the core domain

     * Symbolic Icon
          ** A single explicit visual element used to convey abstract meaning

     * Icon Budget
          ** A rule limiting the number of symbolic icons per image to prevent overload

     * Atmospheric Iconography
          ** Symbolic elements rendered as tonal or silhouetted forms, not physical objects

---

# ASSUMPTIONS

     * Images will often be viewed at small sizes.
     * Topics may be sensitive, geopolitical, or policy-adjacent.
     * Viewers are policy-literate but not technical specialists.
     * Visual restraint is preferred over drama or spectacle.
...
# CHANGE MANAGEMENT
     ...
     * Update this document when:
          ** A new visual domain or modifier is introduced
          ** A repeated failure mode is identified and resolved
          ** Informal guidance is promoted to a binding rule
     * Do not update this document for one-off stylistic experiments.
