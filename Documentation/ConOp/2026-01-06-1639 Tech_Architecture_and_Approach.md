...
# ADMIN INTERFACE
     ...
     * File: admin-interface.html (v8 as of 2026-01-04)
     ...
     * Tab: Dashboard
          ** Stats overview: Total Orgs, Events, Nominated (Pending), Live (Scraping)
     ...
     * Organization Profile Page
          ...
          ** Sub-tab: Status & History
               ...
               *** TOU Assessment: Scanned date, TOU flag, TOU notes, Save button
               *** Permission Request:
