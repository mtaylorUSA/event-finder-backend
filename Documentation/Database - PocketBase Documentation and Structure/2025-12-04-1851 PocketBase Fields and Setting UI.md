...
This document describes the PocketBase admin interface and how to use it.

When providing instructions to add/delete/modify Collections, Fields, or Settings, always include what to enter for each and every data element
